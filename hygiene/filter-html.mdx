...
```php
\Nullai\Hygiene\SanitizeHtml::allowTags(string $html, string $tags, bool $allow): string
```
...
echo \Nullai\Hygiene\SanitizeHtml::allowTags(
    html: '<p><a href="#" class="underline">Link</a></p><div>Other Content</div>',
    tags: 'a:href|class,p',
    allow: true
);
...
With `\Nullai\Hygiene\SanitizeHtml::allowTags()`, you can easily implement secure and customizable HTML sanitization in your applications.